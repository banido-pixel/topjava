                ...
                request.setAttribute("meals",
                        controller.getAll(
                                ...
                                request.getParameter("dateEnd").isEmpty()
                                        ? null : LocalDate.parse(request.getParameter("dateEnd")),
                                request.getParameter("timeStart").isEmpty()
                                        ? null : LocalTime.parse(request.getParameter("timeStart")),
                                request.getParameter("timeEnd").isEmpty()
                                        ? null : LocalTime.parse(request.getParameter("timeEnd"))));
